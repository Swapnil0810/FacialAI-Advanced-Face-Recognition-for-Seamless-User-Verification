...
# cap = cv2.VideoCapture("rtsp://admin:DNWsecurity@103.157.206.124:10554/Streaming/Channels/101")  # capture from camera
...
# frame = cv2.imread(r"C:\Users\chira\OneDrive\Pictures\Camera Roll\amjad.jpg")
# print(predictor.predict(frame, candidate_size / 2, threshold))
# height = 720
...
#     orig_image = cv2.resize(orig_image,(int(weidth), height))
